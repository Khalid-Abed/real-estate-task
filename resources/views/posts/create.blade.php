            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">تسجيل منشور جديد</li>
                    </ol>
                </div>
                <h4 class="page-title">تسجيل منشور جديد</h4>
            </div>
        </div>
    </div>
<!-- end page title -->
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="">تسجيل منشور جديد</h4>
                <div class="col-sm">
                    <form class="needs-validation" method="post" action="{{route('posts.store')}}"  enctype="multipart/form-data"  novalidate>
                        @csrf

                        <div class="row form-row">
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom03" class="my-1">عنوان المنشور </label>
                                <input name="title" type="text" class="form-control" id="validationCustom03" placeholder="عنوان المنشور " value="{{ Request::old('title') }}" required>
                                @error('title')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="contact_number" type="text" class="form-control" id="validationCustom03" placeholder="رقم الهاتف " value="{{ Request::old('contact_number') }}" required>
                        ...
                        <div class="row form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea rows="5" name="description"  class="form-control" id="validationCustom03" placeholder="الكمية " required>{{ Request::old('description') }}</textarea>
                                @error('description')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                                <div class="invalid-feedback">
                        ...
                        <button class="btn btn-success my-3" type="submit">أضافة الوظيفة</button>
