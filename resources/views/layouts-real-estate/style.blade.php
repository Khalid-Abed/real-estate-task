...
<link href="{{asset('dashboard/assets/css/config/material/bootstrap-dark-rtl.min.css')}}" rel="stylesheet" type="text/css" id="bs-dark-stylesheet" />
<link href="{{asset('dashboard/assets/css/config/material/app-dark-rtl.min.css')}}" rel="stylesheet" type="text/css" id="app-dark-stylesheet" />
